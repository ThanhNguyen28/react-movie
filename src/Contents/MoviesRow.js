...
import { setMovieDetails } from "../store/actions/index";
import { useViewport } from "../components/hooks/index";
          ...
          movies.map((movie, index) => {
            if (movie.poster_path && movie.backdrop_path !== null) {
              return (
                ...
                >
                  <img
                    src={ isNetflix ? `https://image.tmdb.org/t/p/original/${movie.poster_path}`
